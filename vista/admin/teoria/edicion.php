             ...
             <div class="col-md-12">
                 ...
                 <div class="box box-default centeredpanel">
                    ...
                    <div class="box-header">
                      <h3 class="box-title">Integrapp <small> - Edición de teorias</small></h3>
                    </div>
                    <!-- form contenido -->
                    <div class="box-body pad">
                       ...
                       <div class="alert alert-info alert-dismissable">
                        ...
                        Puedes hacer busquedas por nombre de teoria.
                       </div>
            ...
            <table class="table table-hover">
                ...
                <?php foreach ($consulta->result() as $fila) {
                 ...
                 <tr>
                    ...
                    <td>'.$fila->fecha.'</td>
                    <td>
                        <a href="'.base_url().'teorias/remove/'.$fila->id_teoria.'" class="btn btn-danger yop" data-url="'.base_url().'teorias/remove/'.$fila->id_teoria.'"><span class="glyphicon glyphicon-trash"></span></a>
                        <a href="'.base_url().'teorias/actualizar/'.$fila->id_teoria.'" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span></a>
                    </td>
                </tr>
                  ';
                } ?>
